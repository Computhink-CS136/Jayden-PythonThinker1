...
#   Total amount saved = $<Z>
# ============================================================
starting_amount = input("What is the starting amount?\n")
num_of_days = int(input("How many days?\n"))
for i in range(1, num_of_days + 1):
    daily_savings = i
    starting_amount = float(starting_amount) + daily_savings
    print(f"Day {i}: ${starting_amount}")
print(f"Total amount of money saved = ${starting_amount}")